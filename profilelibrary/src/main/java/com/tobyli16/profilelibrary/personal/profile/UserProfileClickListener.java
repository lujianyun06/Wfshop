...
import cn.bupt.wfshop.ui.date.DateDialogUtil;
    ...
    public void onItemClick(final BaseQuickAdapter adapter, final View view, int position) {
        ...
        switch (id) {
            case 1:
                                ...
                                RestClient.builder()
                                        ...
                                        .success(new ISuccess() {
                                            ...
                                            public void onSuccess(String response) {
                                                WangfuLogger.d("ON_CROP_UPLOAD", response);
                                        ...
                                        .error(new IError() {
                                            ...
                                            public void onError(int code, String msg) {
                                                Log.e("ON_CROP_UPLOAD",code+"_"+msg);
                                            }
                                        })
                                        .build()
                                        .upload();
                ...
                break;
            case 2:
                final WangfuDelegate nameDelegate = bean.getDelegate();
