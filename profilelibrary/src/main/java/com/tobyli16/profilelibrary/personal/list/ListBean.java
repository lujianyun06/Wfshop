...
public class ListBean implements MultiItemEntity {
    ...
    private int mId = 0;
    private WangfuDelegate mDelegate = null;
    private CompoundButton.OnCheckedChangeListener mOnCheckedChangeListener = null;

    public ListBean(int mItemType, String mImageUrl, String mText, String mValue, int mId, WangfuDelegate mDelegate, CompoundButton.OnCheckedChangeListener mOnCheckedChangeListener) {
    ...
    public WangfuDelegate getDelegate() {
        return mDelegate;
    }
    ...
    public static final class Builder {
        ...
        private WangfuDelegate delegate = null;
        ...
        public Builder setDelegate(WangfuDelegate delegate) {
