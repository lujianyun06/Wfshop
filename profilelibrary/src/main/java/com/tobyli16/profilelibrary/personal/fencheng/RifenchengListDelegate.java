...
public class RifenchengListDelegate extends WangfuDelegate {
    ...
    public Object setLayout() {
        return R.layout.delegate_rifencheng;
    }
    ...
    public void onBindView(@Nullable Bundle savedInstanceState, @NonNull View rootView) {
        mRecyclerView = $(R.id.rv_rifencheng);
...
//                .url("http://tobyli16.com/rifencheng_list.php")
                .url("http://tobyli16.com:8080/wfshop/fencheng/day")
