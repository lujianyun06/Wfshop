...
import cn.bupt.wfshop.ui.camera.CameraImageBean;
import cn.bupt.wfshop.ui.camera.WangfuCamera;
import cn.bupt.wfshop.ui.camera.RequestCodes;
import cn.bupt.wfshop.ui.scanner.ScannerDelegate;
...
public abstract class PermissionCheckerDelegate extends BaseDelegate {
    ...
    void startCamera() {
        WangfuCamera.start(this);
    }

    //这个是真正调用的方法
    public void startCameraWithCheck() {
        PermissionCheckerDelegatePermissionsDispatcher.checkWriteWithPermissionCheck(this);
        PermissionCheckerDelegatePermissionsDispatcher.checkReadWithPermissionCheck(this);
            ...
            switch (requestCode) {
                ...
                case RequestCodes.PICK_PHOTO:
                    if (data != null) {
                        ...
                        final String pickCropPath = WangfuCamera.createCropFile().getPath();
