package cn.bupt.wfshop.net;

import android.content.Context;

import cn.bupt.wfshop.net.callback.IError;
import cn.bupt.wfshop.net.callback.IFailure;
import cn.bupt.wfshop.net.callback.IRequest;
import cn.bupt.wfshop.net.callback.ISuccess;
import cn.bupt.wfshop.net.callback.RequestCallbacks;
import cn.bupt.wfshop.net.download.DownloadHandler;
...
public final class RestClient {
    ...
    private void request(HttpMethod method) {
        ...
        if (LOADER_STYLE != null) {
            WangfuLoader.showLoading(CONTEXT, LOADER_STYLE);
        }
